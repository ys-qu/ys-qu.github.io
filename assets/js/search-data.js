...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/I-attended-the-2026-TRB-Annual-Meeting!/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/Found-RL-accepted-by-Communications-in-Transportation-Research!/";
            },},{id: "news-we-successfully-organized-ngts-2026-at-purdue-university",
          title: '🎉 We successfully organized NGTS 2026 at Purdue University!',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/We-successfully-organized-NGTS-2026-at-Purdue-University!/";
            },},{id: "news-i-joined-honda-ri-as-a-research-intern-this-summer",
          ...
          section: "News",handler: () => {
            ...
            },},{id: "news-i-completed-my-honda-ri-research-internship",
          title: '🎉 I completed my Honda-RI research internship!',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/I-completed-my-Honda-RI-research-internship!/";
