...
<div style="display: flex; flex-direction: column; gap: 20px;">
  ...
  <div style="text-align: center;">
    <img src="/assets/img/honda-ri.jpg" alt="Honda-RI research internship" style="width: 70%; border-radius: 10px;">
    <p style="margin-top: 10px;"><strong>Honda Research Institute USA.</strong></p>
  </div>
