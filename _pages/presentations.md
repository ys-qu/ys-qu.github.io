  ...
  <div class="year-section">
    ...
    <div class="talk-card" style="padding-left: 0;">
      ...
      <div class="talk-images">
        <div class="row">
          <div class="col-md-6">
            <img class="img-fluid rounded z-depth-1" src="/assets/img/news/2025/uiuc/poster.jpg" style="width: 140%; height: 350px; object-fit: cover; object-position: center 70%;" loading="lazy">
    ...
    <div class="talk-card" style="padding-left: 0;">
      ...
      <div class="talk-images">
        <div class="row">
          ...
          <div class="col-md-6">
            <img class="img-fluid rounded z-depth-1" src="/assets/img/news/2025/trb/poster.png" style="width: 140%; height: 350px; object-fit: cover;" loading="lazy">
            <p style="text-align: center; margin-top: 10px; color: var(--global-text-color-light); font-size: 0.9em;">
              Poster
            </p>
          </div>
    ...
    <div class="talk-card" style="padding-left: 0;">
      ...
      <div class="talk-images">
        <div class="row">
          ...
          <div class="col-md-6">
            <img class="img-fluid rounded z-depth-1" src="/assets/img/news/2024/trb/poster.png" style="width: 140%; height: 350px; object-fit: cover;" loading="lazy">
            <p style="text-align: center; margin-top: 10px; color: var(--global-text-color-light); font-size: 0.9em;">
              Poster
            </p>
          </div>
